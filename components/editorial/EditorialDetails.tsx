...
export function EditorialNote({ state }: { state: PuleiroState }) {
  const copy = {
    ...
    preparing: "O trabalho acontece nos bastidores. O Puleiro só informa marcos confirmados pelo serviço.",
    ...
    "configuring-poses": "O Jornal do Puleiro guarda o nome e cada escolha de pose antes de qualquer geração.",
